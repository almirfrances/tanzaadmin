            ...
            <div class="authentication-inner py-4">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="verifyCodeForm" class="mb-3 fv-plugins-bootstrap5 fv-plugins-framework" action="{{ route('admin.verify-reset-code') }}" method="POST" novalidate="novalidate">
                            @csrf
                        ...
                        <div class="text-center">
                            ...
                            <a href="{{ route('admin.forgot-password') }}" class="text-primary">Resend</a>
                        </div>
                    </div>
                </div>
                <!-- /Verify Reset Code -->
